...
<div class="home-main-content">
    <div class="container d-flex justify-content-center">
        @if($user)
            <h1 class="mb-4 home-text">Hi there, {{ htmlspecialchars($user->name) }}</h1>
    ...
    <div class="row">
        <div class="col-sm-6 mb-2">
            <a href="{{ $DiscordJoin }}" class="catalog-card">
                <div class="card">
                    <div class="card-body">
                        <h3><img style="max-width:30px;max-height:30px" class="img-inline align-middle mr-1" src="{{ asset('imgs/discordsvg.svg') }}"> Discord</h3>
        ...
        <div class="col-sm-6 mb-2">
            <a href="{{ $Twitter }}" class="catalog-card">
                <div class="card">
                    <div class="card-body">
                        <h3><img style="max-width:30px;max-height:30px" class="img-inline align-middle mr-1" src="{{ asset('imgs/twittersvg.svg') }}"> Twitter</h3>
